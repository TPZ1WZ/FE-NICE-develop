...
public interface AuthApi {
     ...
     * Request: { "fullName": "Nguyen Van A", "email": "email@example.com", "phone": "0123456789", "password": "123456" }
     * Response: { "success": true, "message": "User registered successfully...", "email": "email@example.com" }
     */
    @POST("api/v1/auth/register")
