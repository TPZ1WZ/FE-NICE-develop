...
public class OrderDetailActivity extends AppCompatActivity {
                    ...
                    public void onResponse(Call<Map<String, Object>> call, Response<Map<String, Object>> response) {
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            if (unavailableProducts != null && !unavailableProducts.isEmpty()) {
                                ...
                                Toast.makeText(OrderDetailActivity.this, fullMessage.toString(), Toast.LENGTH_LONG).show();
                            } else {
    ...
    private void handleReview() {
        Toast.makeText(this, "Tính năng đánh giá sẽ được cập nhật sau", Toast.LENGTH_SHORT).show();
    }
}
